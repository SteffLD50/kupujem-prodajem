...
export const AD_ARGUMENTS = {
    misScorpion: {
        adCategory: "Kompjuteri | Desktop",
        adGroup: "Miševi i podloge",
        adTitle: "Miš Scorpion M207 - Marvo",
        adPrice: "800",
        adDescription:
    ...
    hdmiKabl: {
        adCategory: "TV i Video",
        adGroup: "Kablovi",
        adTitle: "HDMI Kabl 1.5m",
        adPrice: "200",
        adDescription:
    ...
    procesorIntel: {
        adCategory: "Kompjuteri | Desktop",
        adGroup: "Procesori",
        adTitle: "Procesor Intel Core i7-6700 - 3.40 GHz",
        adPrice: "90",
        adDescription:
    ...
    suvenirLambisScorpius: {
        adCategory: "Kolekcionarstvo",
        adGroup: "Suveniri",
        adTitle: "Suvenir - Lambis Scorpius",
        adPrice: "700",
        adDescription:
